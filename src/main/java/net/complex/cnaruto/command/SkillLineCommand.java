...
public class SkillLineCommand {
    ...
    public static int addSkill(Player player, RegistryObject<SkillLine> skillLine)
    {
        player.getCapability(PlayerLevelStatsProvider.PLAYER_LEVELSTATS).ifPresent( (store) ->
        {
            store.AddSkillLineToPlayer(skillLine);
        });
    ...
    public static int removeSkill(Player player, RegistryObject<SkillLine> skillLine)
    {
        player.getCapability(PlayerLevelStatsProvider.PLAYER_LEVELSTATS).ifPresent( (store) ->
        {
            store.RemoveSkillLineFromPlayer(skillLine);
        });
...
//
//        Collection<RegistryObject<SkillLine>> RegisterCollection = SkillLineRegister.SKILL_LINE_REGISTER.getEntries();
//        Iterator<RegistryObject<SkillLine>> It = RegisterCollection.iterator();
//
//
//        It.forEachRemaining((registry) ->{
//            suggestions.add(registry.getId().getPath());
//        });
//
//
//    };
