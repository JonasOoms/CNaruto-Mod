...
public class RamSealHandsign implements IHandsign {

    private static final ResourceLocation icon =  new ResourceLocation(CNaruto.MODID, "textures/gui/handsigns/ram.png");
