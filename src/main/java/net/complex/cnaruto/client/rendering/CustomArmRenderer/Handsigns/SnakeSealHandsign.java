...
public class SnakeSealHandsign implements IHandsign {

    private static final ResourceLocation icon = new ResourceLocation(CNaruto.MODID, "textures/gui/handsigns/snake.png");
    ...
    public CustomArmRenderer.ArmPose GetHandsignArmPose(HumanoidArm arm) {
        return (stack, equip, swing, sign) -> {
            ...
            stack.translate(-0.1*sign,-0.5f,-0.3f);
