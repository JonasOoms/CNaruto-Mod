...
@Mod(CNaruto.MODID)
public class CNaruto
{
    // Define mod id in a common place for everything to reference
    public static final String MODID = "cnaruto";
...
//        // Register our mod's ForgeConfigSpec so that Forge can create and load the config file for us
        FMLJavaModLoadingContext.get().registerConfig(ModConfig.Type.CLIENT, Config.CLIENTSPEC, "cnaruto-config.toml");
    }
